...
// @description	  pixivのイラストページを旧レイアウトっぽくするよ
// @author        ponko
// @homepage      https://userstyles.org/styles/161476
// @run-at        document-start
// @version       0.20210217132140
// ==/UserScript==
(function() {var css = "";
if (false || (document.domain == "pixiv.net" || document.domain.substring(document.domain.indexOf(".pixiv.net") + 1) == "pixiv.net"))
	css += [
		":root {",
...
if (false || (new RegExp("^https://www\\.pixiv\\.net/users/\\d+(\\/(?!following|mypixiv).*)?$")).test(document.location.href) || (document.location.href.indexOf("https://www.pixiv.net/artworks/") == 0))
	css += [
		"body {",
		"		min-width: unset;",
		"	}",
...
if (false || (document.location.href.indexOf("https://www.pixiv.net/artworks/") == 0) || (document.location.href.indexOf("https://www.pixiv.net/users/") == 0))
	css += [
		":root {",
		"		--z-artwork-bg		: #FFF;",
