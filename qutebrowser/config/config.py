## load modules
import os
os.environ['HOME'] = 'C:\\bin\\home'
os.environ['PATH'] += 'C:\\bin\\git\\cmd;C:\\bin\\git\\mingw64\\libexec\\git-core;C:\\bin\\git\\usr\\bin'
del os
...
# c.fileselect.single_file.command = ['C:\\bin\\ppx\\PPCW.EXE', '-single -bootid:t -choose:con8 {}']
...
c.fonts.default_family = ['FirgeNerd Console']
...
## Type: Font
c.fonts.hints = '10pt "Yu Gothic UI"'
...
## Type: Font
c.fonts.messages.error = 'default_size "Yu Gothic UI"'

## Font used for info messages.
## Type: Font
c.fonts.messages.info = 'default_size "Yu Gothic UI"'

## Font used for warning messages.
## Type: Font
c.fonts.messages.warning = 'default_size "Yu Gothic UI"'
...
## Type: Font
c.fonts.tabs.selected = 'default_size "Yu Gothic UI"'
...
## Type: FontFamily
c.fonts.web.family.fixed = 'FirgeNerd Console'

## Font family for sans-serif fonts.
## Type: FontFamily
c.fonts.web.family.sans_serif = 'Yu Gothic UI'
...
## Type: FontFamily
c.fonts.web.family.standard = 'Yu Gothic UI'
...
c.tabs.indicator.padding = {'top': 7, 'bottom': 5, 'left': 0, 'right': 4}
...
c.tabs.padding = {'top': 0, 'bottom': 1, 'left': 5, 'right': 5}
