...
var g_menuOrder = PPx.Arguments(0);

// 拡張子を大文字で取得する
var g_fileType = (PPx.GetFileInformation(PPx.Extract('%R')) === ':DIR') ?
  'DIR' :
  PPx.Extract('%t').toUpperCase();

// メニュー毎の初期選択キー
var g_menu = (function () {
  var objHOP = Object.prototype.hasOwnProperty;
  for (var item in ITEMS) {
    if (objHOP.call(ITEMS, item)) {
...
var getMenu = function (list, arch) {
